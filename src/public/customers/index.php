        ...
        <div class="row">
            <div class="col-md-2">
                <div class="list-group">
                    <a href="index.php" class="list-group-item active">All Customers</a>
                    <a href="#" class="list-group-item">Search Customers</a>
                    <a href="" class="list-group-item">Add Customer</a>
                </div>
            </div>
            <div class="col-md-10">
                <div class="page_header"><h3>All Customers</h3></div>
