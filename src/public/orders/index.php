        ...
        <div class="row">
            <div class="col-md-2">
                <div class="list-group">
                    <a href="index.php" class="list-group-item active">All Orders</a>
                    <a href="#" class="list-group-item">Search Orders</a>
                    <a href="#" class="list-group-item">Add Orders</a>
                </div>
            </div>
            <div class="col-md-10">
                <div class="page_header"><h3>All Orders</h3></div>
